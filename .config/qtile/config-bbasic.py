...
wallDir = "/home/grey/wallpapers/gruv/"
...
main_font =     "JetbrainsMonoNerdFont"; fn_size = 12
imagesPath =    "/home/bbasic/.config/qtile/appImages"
scripts_path =  "/home/grey/.config/qtile/"
wallfile =		f"{wallDir/gruv-oni.png}" 
dmenu_run =     f"dmenu_run -i -p 'exec: ' -sb #c8ccd6 -sf #121212 -nb #080808 -l 4"

# --- / MODKEYS / ---
MOD  = "mod1";      #WINDOWS KEY
ALT  = "mod1";      #ALT KEY
